...
OUT = ROOT / "deliverables" / "CFI_Hotels_Group_project_EN"
ASSETS = OUT / "assets"
...
def render() -> Image.Image:
    ...
    letterspaced(draw, (1050, y + 55), "LODZ / MICE", F["sans_bold_20"], COPPER_LIGHT, 7)
    y += 144
    ...
    title_y = y + 840
    draw.text((70, title_y), "From Scheibler", font=F["serif_82"], fill=WHITE)
    draw.text((770, title_y), "to", font=F["serif_82"], fill=WHITE)
    draw.text((866, title_y), "POLMO", font=F["serif_82"], fill=WHITE)
    hero_eyebrow = "TWO NEW EVENT SPACES IN LODZ"
    hero_spacing = 6
    ...
    draw.text((96, y + 100), "Lodz.", font=F["serif_52"], fill=COPPER)
    draw.text((96, y + 160), "A city that", font=F["serif_44"], fill=COPPER)
    draw.text((96, y + 214), "has always", font=F["serif_44"], fill=COPPER)
    draw.text((96, y + 268), "made history.", font=F["serif_44"], fill=COPPER)
    intro_1 = "In the heart of a city that shaped Polish industry for decades, CFI Hotels Group is creating meeting places where history, architecture and modern hospitality come together."
    intro_2 = "Two new event spaces have joined the group portfolio, each rooted directly in the industrial heritage of Lodz."
    ...
    timeline_1855 = "In 1855, Karol Scheibler, known as the cotton king, opened his own spinning mill at Wodny Rynek in Lodz, today Plac Zwyciestwa 2. It marked the beginning of his textile empire."
    ...
    timeline_1908 = "The history of the Lodz Automotive Accessories Factory, FOS Polmo, at 99 Przybyszewskiego Street dates back to 1908. It began as a foundry, entered the automotive sector in 1929 and operated independently from 1945."
    ...
    letterspaced(draw, (96, y + 105), "01 / POLMO / 99 PRZYBYSZEWSKIEGO ST.", F["sans_bold_20"], COPPER, 5)
    draw.text((96, y + 160), "99Hz", font=F["serif_82"], fill=INK)
    draw_wrapped(draw, "A modern event space with an automotive past", (96, y + 262), F["serif_italic_38"], 930, COPPER, 52)
    ...
    col_w = 570
    x1, x2 = 96, 774
    lead = "99Hz is an elegant conference and event space located inside Citi Hotel's Lodz at 99 Przybyszewskiego Street."
    p1 = "The venue was created on the site of the former POLMO automotive works, for many years an important part of the city industrial history."
    p2 = "This heritage is reflected in the interior, where distinctive metal details refer to the automotive past of the location."
    p3 = "Modern architecture, professional multimedia facilities and direct access to 114 rooms at Citi Hotel's Lodz create a complete solution for conferences, trainings, galas, banquets\nand corporate events."
    p4 = "It is a space designed for those who expect more than a standard conference room."
    ...
    hz_capacities = [
        ("145 sqm", "VENUE AREA"),
        ("UP TO 120", "GUESTS AT RECTANGULAR TABLES"),
        ("UP TO 80", "GUESTS AT ROUND TABLES"),
        ("UP TO 150", "GUESTS IN A COCKTAIL FORMAT (STANDING PARTY)"),
    ]
    capacity_w = (W - 192) // 4
    ...
    letterspaced(draw, (hx, y + 42), "HISTORICAL NOTE / POLMO", F["sans_bold_20"], COPPER_LIGHT, 4)
    draw.text((hx, y + 91), "From foundry work", font=F["serif_38"], fill=WHITE)
    draw.text((hx, y + 138), "to automotive specialization", font=F["serif_38"], fill=WHITE)
    history_intro = "FOS POLMO was formed from eight Lodz plants, combining foundry work, engine construction and component production for the Polish automotive industry."
    draw_wrapped(draw, history_intro, (hx, y + 202), F["sans_20"], 645, MUTED_WHITE, 31)
    history_items = [
        ("1908", "The Ferrum Iron Foundry is established, the date from which the plant traced its history."),
        ("1929", "Roman Klinger establishes an Automotive Accessories Factory."),
        ("1952", "Carburetor production begins, one of the plant key specializations."),
        ("1968", "The name Automotive Accessories Factory POLMO is adopted."),
    ]
    ...
    letterspaced(draw, (hx, y + 632), "HISTORIC ASSEMBLY HALL - FOS POLMO GUIDE, 1978", F["sans_bold_13"], "#77716a", 1)
    y += history_h + 90

    draw.line((96, y, W - 96, y), fill="#a99e90", width=2)
    facts = [("114", "ROOMS AT CITI HOTEL'S LODZ"), ("MICE", "CONFERENCES, TRAININGS AND GALAS"), ("AV", "PROFESSIONAL MULTIMEDIA\nAIR CONDITIONING")]
    fact_w = (W - 192) // 3
    ...
    letterspaced(draw, (96, y + 105), "02 / SCHEIBLER CENTRAL COMPLEX / PLAC ZWYCIESTWA 2", F["sans_bold_20"], COPPER_LIGHT, 5)
    ...
    draw_wrapped(draw, "Industrial elegance in the historic Scheibler Central Complex", (96, y + 334), F["serif_italic_38"], 930, COPPER_LIGHT, 52)
    ...
    canvas.paste(image, (0, y))
    y += image_h + 84
    lead2 = "At Plac Zwyciestwa 2, one of the most distinctive places on the map of Lodz awaits."
    t1 = "Tektura by Farina Bianco is located in the historic complex of Karol Scheibler former factory, known as Centrala."
    t2 = "Built between 1855 and 1870, the complex is one of the city most important industrial monuments\nand a symbol of Lodz entrepreneurship and industrial growth."
    t3 = "Today, the restored interiors impress with authentic brick, monumental glazing\nand a one-of-a-kind atmosphere, creating an ideal backdrop for galas, product launches, conferences, banquets\nand private events."
    ...
    key_label = "KEY INFORMATION AND ADVANTAGES"
    ...
    key_values = [
        ("600 sqm", "EVENT SPACE AREA"),
        ("FROM 40", "GUESTS - PRIVATE EVENTS"),
        ("UP TO 180", "GUESTS AT ROUND OR RECTANGULAR TABLES"),
        ("UP TO 300", "GUESTS IN A COCKTAIL FORMAT (STANDING PARTY)"),
    ]
    key_col_w = key_w // 4
    key_values_y = y + 78
    ...
    key_amenities = ["Park surroundings", "Discreet VIP entrance", "Internal patio", "Space for a dance floor"]
    ...
    hx = history_x + image_w + 42
    letterspaced(draw, (hx, y + 38), "HISTORICAL NOTE / SCHEIBLER CENTRAL COMPLEX", F["sans_bold_20"], COPPER, 3)
    draw.text((hx, y + 88), "The place where an", font=F["serif_38"], fill=INK)
    draw.text((hx, y + 135), "industrial empire began", font=F["serif_38"], fill=INK)
    scheibler_intro = "The Scheibler Central Complex at Plac Zwyciestwa 2 is the oldest part of Karol Scheibler former cotton factory. It gave rise to one of the largest industrial empires of 19th-century Europe and remains a key Lodz landmark."
    draw_wrapped(draw, scheibler_intro, (hx, y + 198), F["sans_20"], 645, "#514b44", 30)
    scheibler_items = [
        ("1855", "Karol Scheibler begins his industrial activity in Lodz."),
        ("1858", "The oldest part of the Centrala complex is built."),
        ("19th c.", "The beginning of one of Europe largest industrial empires."),
        ("TODAY", "Tektura by Farina Bianco - Plac Zwyciestwa 2."),
    ]
    ...
    letterspaced(draw, (hx, y + 690), "FACTORY GATE - 1936-1938 - STATE ARCHIVE IN LODZ / FOTOPOLSKA.EU", F["sans_bold_20"], "#8b7f70", 1)
    y += scheibler_h + 90
    ...
    draw.text((96, y + 132), "History is not decoration.", font=F["serif_italic_38"], fill=COPPER_LIGHT)
    draw.text((96, y + 180), "It is part of every event.", font=F["serif_italic_38"], fill=COPPER_LIGHT)
    letterspaced(draw, (1030, y + 85), "LODZ", F["sans_bold_20"], MUTED_WHITE, 6)
    letterspaced(draw, (914, y + 132), "NEW EVENT", F["sans_bold_20"], MUTED_WHITE, 4)
    letterspaced(draw, (1032, y + 175), "SPACES", F["sans_bold_20"], MUTED_WHITE, 4)
    y += footer_h
